...
<head>
    ...
    <link href="{{ asset('sbAdmin_Template/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
    <link
...
<body id="page-top">
     ...
     <div class="text-center">
          ...
          <p class="lead text-gray-800 mb-5">Halaman Dibatasi</p>
          <p class="text-gray-500 mb-0">Anda tidak memiliki hak akses untuk halaman ini ...</p>
     </div>
     </div>
