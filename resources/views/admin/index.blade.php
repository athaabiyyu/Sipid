               ...
               <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                         ...
                         <div class="col mr-2">
                              ...
                              <div class="row mt-3">
                                   <div class="col">
                                        <a href="{{ route('admin.rekap_laporan', ['status' => 1]) }}" class="btn btn-secondary btn-sm">Detail &rarr;</a>
                                   </div>
                              </div>
                              @endif
                         </div>
               ...
               <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                         ...
                         <div class="col mr-2">
                              ...
                              <div class="row mt-3">
                                   <div class="col">
                                        <a href="{{ route('admin.rekap_laporan', ['status' => 3]) }}" class="btn btn-secondary btn-sm">Detail &rarr;</a>
                                   </div>
                              </div>
                              @endif
                         </div>
               ...
               <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                         ...
                         <div class="col mr-2">
                              ...
                              <div class="row mt-3">
                                   <div class="col">
                                        <a href="{{ route('admin.rekap_laporan', ['status' => 4]) }}" class="btn btn-secondary btn-sm">Detail &rarr;</a>
                                   </div>
                              </div>
                              @endif
                         </div>
               ...
               <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                         ...
                         <div class="col mr-2">
                              ...
                              <div class="row mt-3">
                                   <div class="col">
                                        <a href="{{ route('admin.rekap_laporan', ['status' => 7]) }}" class="btn btn-secondary btn-sm">Detail &rarr;</a>
                                   </div>
                              </div>
                              @endif
                         </div>
               ...
               <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                         ...
                         <div class="col mr-2">
                              ...
                              <div class="row mt-3">
                                   <div class="col">
                                        <a href="{{ route('admin.rekap_laporan', ['status' => 9]) }}" class="btn btn-secondary btn-sm">Detail &rarr;</a>
                                   </div>
                              </div>
                              @endif
                         </div>
