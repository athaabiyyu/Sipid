          ...
          <div class="col-md-9">
               <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                         <h6 class="m-0 font-weight-bold text-primary">+ Form Tambah Level</h6>
                    ...
                    <div class="card-body">
                         ...
                         <div class="mb-3">
                              <div class="mb-3">
                                   ...
                                   placeholder="Masukkan Kode Level" value="{{ old('level_kode') }}">
                              ...
                              <div class="mb-3">
                                   ...
                                   placeholder="Masukkan Nama level" value="{{ old('level_nama') }}">
