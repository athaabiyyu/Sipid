...
<div class="col-xl-4 col-md-6 mb-5">
     <div class="card border-left-warning shadow h-100 ">
          ...
          <div id="dikirim-rw-footer" class="card-footer p-0">
               @if ($totalLaporanDikirimKeRw > 0)
                    <div class="card-footer bg-white p-0 ">
                         <div class="row">
                              <div class="col">
                              <a href="{{ route('rw.hasil_laporan', ['status' => 7]) }}" class="text-warning d-flex justify-content-between align-items-center p-2" style="text-decoration: none;">
...
<div class="col-xl-4 col-md-6 mb-5">
     <div class="card border-left-secondary shadow h-100 ">
          ...
          <div id="direalisasikan-rw-footer" class="card-footer p-0">
               @if ($totalLaporanDirealisasikan > 0)
                    <div class="card-footer bg-white p-0 ">
                         <div class="row">
                              <div class="col">
                              <a href="{{ route('rw.hasil_laporan', ['status' => 8]) }}" class="text-secondary d-flex justify-content-between align-items-center p-2" style="text-decoration: none;">
                                   <h6 class="mb-0 ml-2 font-weight-bold">Detail</h6>
                                   <i class="fas fa-arrow-right mr-2"></i>
                              </a>
                              </div>
...
<div class="col-xl-4 col-md-6 mb-5">
     <div class="card border-left-success shadow h-100 ">
          ...
          <div id="selesai-rw-footer" class="card-footer p-0">
...
#dikirim-rw-footer a:hover {
    background-color: #f6c23e; /* Bootstrap warning color */
}

#direalisasikan-rw-footer a:hover {
    background-color: #5a5c69; /* Custom dark color */
}

#selesai-rw-footer a:hover {
