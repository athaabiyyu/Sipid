...
@section('content')
     ...
     <div class="row">
          ...
          <div class="col-md-8">
               <div class="card mb-4 py-3 border-bottom-primary">
                    <div class="p-3 py-3">
                         <form action="{{ route('rw.edit_profile') }}" method="POST" enctype="multipart/form-data">
                         @csrf
                         ...
                         <div class="row mt-4">
                              <div class="col">
                                   ...
                                   <input type="number" name="user_nik" value="{{ auth()->user()->user_nik }}"
                                        class="form-control @error('user_nik') is-invalid @enderror">
                                   @error('user_nik')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                   @enderror
                              </div>
